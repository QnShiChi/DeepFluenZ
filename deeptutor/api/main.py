...
app.include_router(exam_attempts.router, prefix="/api/v1", tags=["exam-attempts"])
...
app.include_router(graph_timeline.router, prefix="/api/v1/graph", tags=["graph-timeline"])
